...
export default function details({navigation}) {
    ...
    return (
       ...
       <View style={styles.nameUser}>
         <Text style={{fontSize: 18, margin: 10}} >{dados.Nome}</Text>
       </View>
        : null}
        ...
        <View style={styles.containerMain}>
            ...
            <View style={styles.alignCenter} >
                <Feather  name="user" size={30} color="#058069"  />
                <Text style={styles.titleContainer}>Perfil</Text>
            </View>
            </TouchableOpacity>

            <TouchableOpacity style={styles.viewContainer}>
            <View style={styles.alignCenter} >
                <AntDesign name="plussquareo" size={30} color="#058069" />
                <Text style={styles.titleContainer}>Consultas</Text>
            </View>
            </TouchableOpacity>
            ...
            <View style={styles.alignCenter} >
                <AntDesign name="linechart" size={30} color="#058069" />
                <Text style={styles.titleContainer} >Extratos</Text>
            </View>
      
            </TouchableOpacity>

            <TouchableOpacity  style={styles.viewContainer}>
                    <View style={styles.alignCenter} onPress={() =>   navigation.navigate('Carteirinha') } >
                        <AntDesign name="creditcard" size={30} color="#058069" />
                        <Text style={styles.titleContainer}>Carteirinha</Text>
                    </View>
            </TouchableOpacity>

            <TouchableOpacity style={styles.viewContainer}>
                    <View style={styles.alignCenter} onPress={() =>   navigation.navigate('Carteirinha') } >
                        <Feather name="map" size={30} color="#058069" />
                        <Text style={styles.titleContainer}>Rede Credenciada</Text>
                    </View>
            </TouchableOpacity>

            <TouchableOpacity style={styles.viewContainer}>
                    <View style={styles.alignCenter} onPress={() =>   navigation.navigate('Carteirinha') } >
                        <AntDesign name="phone" size={30} color="#058069" />
                        <Text style={styles.titleContainer}>Contatos</Text>
                    </View>
            </TouchableOpacity>
